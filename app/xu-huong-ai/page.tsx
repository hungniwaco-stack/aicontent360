...
export const metadata: Metadata = { title: "Xu Hướng AI cho Content: công cụ và cách làm mới đáng chú ý", description: "Tin tức AI, workflow AI và ứng dụng thực chiến cho content marketing." };
