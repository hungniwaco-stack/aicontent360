...
function SimplePage({ title, desc }: { title: string; desc: string }) {
  return <div className="container-shell py-12"><h1 className="text-3xl font-bold">{title}</h1><p className="mt-3 text-slate-600">{desc}</p></div>;
}
